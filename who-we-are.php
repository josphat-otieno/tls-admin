...
<head>
  <meta charset="utf-8" />
  <title>EK Consulting Admin - Who We Are</title>
          ...
          <!-- <div class="row">
            <div class="col-12">
              <div class="page-title-box">
                <h4 class="page-title">Who We Are</h4>
              </div>
            </div>
          </div> -->
          <!-- end page title -->
            ...
            <div class="col-12">
              ...
              <div id="edit-form" class="edit-form">
                <form action="edit_static_content.php" method="POST">
                  <input type="hidden" name="page_name" value="who_we_are">
                  <input type="hidden" name="redirect_page" value="who-we-are.php">
