...
$sql = "SELECT * FROM members WHERE member_type = 'board' ORDER BY id ASC";
...
<head>
    <meta charset="utf-8" />
    <title>TLS CMS Admin - Board Members</title>
...
<body class="loading" data-layout-color="light" data-layout-mode="default" data-layout-size="fluid"
            ...
            <div class="modal-content modal-filled bg-success">
                <div class="modal-body">
                    <div class="text-center">
                        ...
                        <p class="mt-3 text-white">Board member has been updated successfully</p>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modal-title">Add Board Member</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="member-form" action="edit_member.php" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="member_type" value="board">
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <button class="btn btn-primary" onclick="openAddModal()">
                                        <i class="mdi mdi-plus-circle me-1"></i> Add Board Member
                                    </button>
                                </div>
                                    ...
                                    <div class="card member-card">
                                        <div class="card-body text-center">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <a href="edit_member.php?delete_member=<?php echo $member['id']; ?>&type=board" class="btn btn-sm btn-outline-danger" onclick="return confirm('Are you sure you want to delete this member?')">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body text-center py-5">
                                        ...
                                        <h4 class="mt-3">No Board Members Yet</h4>
                                        <p class="text-muted">Click the "Add Board Member" button to get started.</p>
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
    ...
    <script>
        ...
        function openAddModal() {
            document.getElementById('modal-title').textContent = 'Add Board Member';
        ...
        function editMember(member) {
            document.getElementById('modal-title').textContent = 'Edit Board Member';
